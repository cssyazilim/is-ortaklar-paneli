...
<body class="bg-gray-50 min-h-screen">
    ...
    <div id="sidebar" class="fixed left-0 top-0 h-full w-64 bg-white shadow-lg z-40 sidebar-transition transform -translate-x-full">
        ...
        <nav class="p-4 space-y-2 overflow-y-auto h-full pb-20">
            ...
            <!-- Teklif Talep Et -->
            <a href="teklif.php" onclick="showModule('request-quote')" class="menu-item flex items-center p-3 text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-600 transition-colors">
                <svg class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
           ...
           <!-- Tekliflerim -->
            <a href="tekliflerim.php" class="menu-item flex items-center p-3 text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-600 transition-colors">
                <svg class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Siparişlerim -->
            <a href="siparislerim.php#" onclick="showModule('orders')" class="menu-item flex items-center p-3 text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-600 transition-colors">
                <svg class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
